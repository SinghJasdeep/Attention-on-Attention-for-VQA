...
from models_HM import build_baseline, build_model_A1, build_model_A2, build_model_A3,build_model_AP,\
...
def parse_args():
    ...
    parser.add_argument('--modelpath', metavar='', type=str,\
    default='./saved_models/A3x2_1280_LeakyReLU_Adamax_D0.3_DL0.1_DG0.2_DW0.4_DC0.5_w0_initializer_kaiming_normal/model.pth',\
    ...
    parser.add_argument('--optimizer', type=str, default='Adamax', help='Adamax, Adadelta, RMSprop')
...
if __name__ == '__main__':
    ...
    output = args.output + args.model + '_' + str(args.num_hid) + '_' + args.activation + '_' + args.optimizer +\
            ...
            + '_DC' + str(args.dropout_C) + '_w' + str(args.weight_decay) + '_initializer_' + args.initializer
